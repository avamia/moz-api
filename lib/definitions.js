module.exports = {
  "apu" : "Returns phrases found in links to the target URL",
  "apf" : "Returns phrases found in links to the subdomain of the target URL",
  "app" : "Returns phrases found in links to the root domain of the target URL",
  ...
  "eu"  : "The number of external pages linking to the target URL containing this term or phrase",
  "ef"  : "The number of external subdomains with at least one link to the target URL containing this term or phrase",
  "ep"  : "The number of external root domains with at least one link to the target URL containing this term or phrase",
  "emp" : "The amount of MozRank passed over all external links with this term or phrase (on a normalized 10-point scale)",
  ...
  "t"    : "The anchor text term or phrase",
